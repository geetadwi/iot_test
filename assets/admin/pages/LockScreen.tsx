    ...
    return (
        <div className="page-sign">
            <Card className="card-sign">
                ...
                <Card.Body>
                    <Link to={AdminPages.DASHBOARD} className="card-thumb">
                        <img src={img1} alt="" />
                    </Link>
                    <div className="mb-4">
                        <Form.Label className="d-flex justify-content-between">
                            Password{' '}
                            <Link to={AdminPages.DASHBOARD}>Forgot password?</Link>
                        </Form.Label>
                ...
                <Card.Footer>
                    Not you?{' '}
                    <Link to={AdminPages.SIGN_IN}>Sign in with different account</Link>
                </Card.Footer>
            </Card>
        </div>
    );
